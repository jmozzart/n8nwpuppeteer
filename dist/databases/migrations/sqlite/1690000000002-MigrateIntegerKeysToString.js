...
function getSqliteDbFileSize() {
    const filename = path_1.default.resolve(typedi_1.Container.get(n8n_core_1.InstanceSettings).n8nFolder, typedi_1.Container.get(config_1.GlobalConfig).database.sqlite.database);
