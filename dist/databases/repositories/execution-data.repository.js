...
const execution_data_1 = require("../entities/execution-data");
let ExecutionDataRepository = class ExecutionDataRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(execution_data_1.ExecutionData, dataSource.manager);
    }
    async createExecutionDataForExecution(data, transactionManager) {
        return await transactionManager.insert(execution_data_1.ExecutionData, data);
    }
