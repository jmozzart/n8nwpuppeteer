...
const annotation_tag_mapping_repository_ee_1 = require("../databases/repositories/annotation-tag-mapping.repository.ee");
const execution_annotation_repository_1 = require("../databases/repositories/execution-annotation.repository");
...
exports.ExecutionService = ExecutionService = __decorate([
    ...
    __metadata("design:paramtypes", [config_1.GlobalConfig,
        ...
        execution_annotation_repository_1.ExecutionAnnotationRepository,
        annotation_tag_mapping_repository_ee_1.AnnotationTagMappingRepository,
