...
let WaitingWebhooks = class WaitingWebhooks {
    ...
    async getWebhookExecutionData({ execution, req, res, lastNodeExecuted, executionId, suffix, }) {
        ...
        return await new Promise((resolve, reject) => {
            ...
            void WebhookHelpers.executeWebhook(workflow, webhookData, workflowData, workflowStartNode, executionMode, runExecutionData.pushRef, runExecutionData, execution.id, req, res, (error, data) => {
                if (error !== null) {
                    return reject(error);
                }
                resolve(data);
