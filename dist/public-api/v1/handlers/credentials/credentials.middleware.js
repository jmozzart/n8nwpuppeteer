...
const validCredentialType = (req, res, next) => {
    try {
        typedi_1.Container.get(credential_types_1.CredentialTypes).getByName(req.body.type);
    }
    catch {
...
const validCredentialsProperties = (req, res, next) => {
    ...
    const properties = typedi_1.Container.get(credentials_helper_1.CredentialsHelper)
