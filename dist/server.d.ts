...
export declare class Server extends AbstractServer {
    ...
    constructor(loadNodesAndCredentials: LoadNodesAndCredentials, orchestrationService: OrchestrationService, postHogClient: PostHogClient, eventService: EventService, instanceSettings: InstanceSettings);
    start(): Promise<void>;
