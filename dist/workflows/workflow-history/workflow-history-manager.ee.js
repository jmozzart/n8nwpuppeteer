...
let WorkflowHistoryManager = class WorkflowHistoryManager {
    ...
    init() {
        ...
        this.pruneTimer = setInterval(async () => await this.prune(), 1 * constants_1.Time.hours.toMilliseconds);
    }
    shutdown() {
        if (this.pruneTimer !== undefined) {
            clearInterval(this.pruneTimer);
...
exports.WorkflowHistoryManager = WorkflowHistoryManager = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [workflow_history_repository_1.WorkflowHistoryRepository])
