...
class Pagination {
    static fromString(rawTake, rawSkip) {
        if (!(0, utils_1.isIntegerString)(rawTake)) {
            throw new n8n_workflow_1.ApplicationError('Parameter take is not an integer string');
        }
        if (!(0, utils_1.isIntegerString)(rawSkip)) {
            throw new n8n_workflow_1.ApplicationError('Parameter skip is not an integer string');
        }
