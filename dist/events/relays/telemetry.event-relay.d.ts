...
export declare class TelemetryEventRelay extends EventRelay {
    ...
    constructor(eventService: EventService, telemetry: Telemetry, license: License, globalConfig: GlobalConfig, workflowRepository: WorkflowRepository, nodeTypes: NodeTypes, sharedWorkflowRepository: SharedWorkflowRepository, projectRelationRepository: ProjectRelationRepository);
    init(): Promise<void>;
