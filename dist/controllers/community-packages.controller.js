...
let CommunityPackagesController = class CommunityPackagesController {
    constructor(push, communityPackagesService, eventService) {
        this.push = push;
    ...
    async installPackage(req) {
        ...
        try {
            installedPackage = await this.communityPackagesService.installPackage(parsed.packageName, parsed.version);
        }
        catch (error) {
    ...
    async updatePackage(req) {
        ...
        try {
            const newInstalledPackage = await this.communityPackagesService.updatePackage(this.communityPackagesService.parseNpmPackageName(name).packageName, previouslyInstalledPackage);
